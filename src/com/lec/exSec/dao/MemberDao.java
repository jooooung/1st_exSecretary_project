	...
	public MemberDto getMember(String mid) {
		...
		try {
			...
			if(rs.next()) {
				...
				member = new MemberDto(mid, mpw, mname, mphoto, mtel, memail, mgender, mbirth, mrdate);
			}
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}finally {
	...
	public ArrayList<MemberDto> getMemberlist(int startRow, int endRow) {
		...
		try {
			...
			while(rs.next()) {
				...
				Date   mbirth = rs.getDate("mbirth");
				Date mrdate =rs.getDate("mrdate");
				members.add(new MemberDto(mid, mpw, mname, mphoto, mtel, memail, mgender, mbirth, mrdate));
			}
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}finally {
